...
/**
 * Loads the given markdownURL and appends it to the body. 
 */
function load(markdownURL) {
    $.ajax({
            url: markdownURL,
            type: "GET",
            ...
            error: function(data){
                $("body")
                    .append("<h1>Error loading markdown file</h1>")                
                    .append("<p>Can't load <code>" + markdownURL + "</code>.</p>")                
                    .append("<p>Try to open <a href='" + markdownURL + "'>the markdown file directly</a></code> or use IE (for file:/// protocol).</p>");                
            }
    });
}